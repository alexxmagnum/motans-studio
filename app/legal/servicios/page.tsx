...
export const metadata: Metadata = createMsSitePageMetadata("legalServicios");

export default function LegalServiciosPage(): React.ReactElement {
  return <MsSiteLegalDocument page={getMsSiteLegalPage("servicios")} />;
}
