...
describe("Commercial Site SEO", () => {
  it("should have metadata in layout.tsx", () => {
    ...
    assert.ok(content.includes("title"), "metadata should have title");
    assert.ok(content.includes("description"), "metadata should have description");
  });
  ...
  it("should have semantic HTML structure", () => {
    ...
    assert.ok(shell.includes("<footer"), "shell should have footer element");
    assert.ok(shell.includes('role="contentinfo"'), "footer should have contentinfo role");
  });
  ...
  it("should have skip link for accessibility", () => {
    ...
    assert.ok(content.includes('href="#main-content"'), "should have skip link");
